      ...
      <footer className="footer py-10 px-4 bg-neutral  text-neutral-content">
        <aside className="  max-w-6xl mx-auto space-y-2">
          ...
          <p>
            ...
            +88 123456789 <br />
            Mon - Fri: 08:00 - 22:00 Sat - Sun: 10:00 - 23:00
          </p>
        </aside>
        <div className="border-r-2 border-slate-600 h-full"></div>
        <nav className="mx-auto">
          <header className="footer-title tetx-center font-bold text-3xl">
            Social
          </header>
